...
<body>
	...
	<%
		...
		if (days == null){
			...
			script.println("location.href = 'weekday.jsp'");
			script.println("</script>");
		}
	%>
	<!-- 내비게이션바 -->
	...
	<ul class="cteta ctetalit">
		<li class="ctetalit">
			<a class="ctetalita" href="weekday.jsp">요일전체</a>
		</li>
		<li class="ctetalit">
			<a class="ctetalita
		<%if(days.equals("mon")){%>
		<%= style %> 
		<% }%>
		" href="weekdayList.jsp?week=mon">월요웹툰</a>
		</li>
		<li class="ctetalit">
			<a class="ctetalita
		<%if(days.equals("tue")){%>
		<%= style %>
		<% }%>
		"href="weekdayList.jsp?week=tue">화요웹툰</a>
		</li>
		<li class="ctetalit">
			<a class="ctetalita
		<%if(days.equals("wed")){%>
		<%= style %>
		<% }%>
		"href="weekdayList.jsp?week=wed">수요웹툰</a>
		</li>
		<li class="ctetalit">
			<a class="ctetalita
		<%if(days.equals("thu")){%>
		<%= style %>
		<% }%>
		"href="weekdayList.jsp?week=thu">목요웹툰</a>
		</li>
		<li class="ctetalit">
			<a class="ctetalita
		<%if(days.equals("fri")){%>
		<%= style %>
		<% }%>
		"href="weekdayList.jsp?week=fri">금요웹툰</a>
		</li>
		<li class="ctetalit">
			<a class="ctetalita
		<%if(days.equals("sat")){%>
		<%= style %>
		<% }%>
		"href="weekdayList.jsp?week=sat">토요웹툰</a>
		</li>
		<li class="ctetalit">
			<a class="ctetalita
		<%if(days.equals("sun")){%>
		<%= style %>
		<% }%>
		"href="weekdayList.jsp?week=sun">일요웹툰</a>
		</li>
	</ul>
	</div>
